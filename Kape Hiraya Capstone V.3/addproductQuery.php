...
if(isset($_POST['add_product']))
{
    ...
    $sql="INSERT INTO `products`(`name`, `quantity`,  `price2`, `price3`, `price4`)
...
if($_POST['product_id'] != ""){
    ...
    if($result->num_rows > 0){
        ...
        while($row = $result->fetch_assoc()){
            ...
            $array_result['UproductPrice2'] = $row['price2'];
            $array_result['UproductPrice3'] = $row['price3'];
            $array_result['UproductPrice4'] = $row['price4'];
